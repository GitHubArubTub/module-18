...
if st.button("Add Block"):
    ...
    # Create a Record object with the sender, receiver, and amount values
    new_record = Record(sender=sender, receiver=receiver, amount=amount)

    # Create a new Block with the Record as its record attribute
    new_block = Block(
        record=new_record,  # Pass the new_record object here
        creator_id=42,
